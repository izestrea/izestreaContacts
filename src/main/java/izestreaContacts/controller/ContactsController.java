package izestreaContacts.controller;
...
import izestreaContacts.service.ContactService;
...
public class ContactsController {
	...
	public ResponseEntity<?> delete(@PathVariable("contactId") int contactId,
		...
		return createListAllResponse(page, locale, "message.detele.success");
	}
	...
	private ContactListVO addActionMessageToVO(ContactListVO contactListVO, Locale locale, String actionMessageKey,
			Object[] args) {
		if(StringUtils.isEmpty(actionMessageKey)) {
